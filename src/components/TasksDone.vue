<template>
  ...
  <div class = "width-500" id="tasklist">
    <div class ="formTodo">
      ...
      <h3 class="app-header">Danh sách các việc đã làm</h3>
      <div class="app-input">
      ...
      <ul class="app-list" >
        <template v-for="task of tasks.slice().reverse()" :key="task">
          <li class="task-list-item" v-if="task.completed == true"> <!-- .slice().reverse()-->  
            <input  class="checked" title = "Complete Task" type="checkbox" @click="complete(task)">
